...
let ChecksSeeder = ChecksSeeder_1 = class ChecksSeeder {
    prisma;
    logger = new common_1.Logger(ChecksSeeder_1.name);
    constructor(prisma) {
        this.prisma = prisma;
    }
    async onModuleInit() {
        try {
            ...
            this.logger.error('Seeding failed (DB unavailable?): ' + e.message);
        }
    }
};
exports.ChecksSeeder = ChecksSeeder;
exports.ChecksSeeder = ChecksSeeder = ChecksSeeder_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], ChecksSeeder);
//# sourceMappingURL=checks.seeder.js.map